...
const serviceShcema = new mongoose.Schema({ 
    ...
    whychoseDescription: { type: String, required: false,default:" " },
    whychoseTitle: { type: String, required: false,default:" " },
...
module.exports = mongoose.model('service', serviceShcema);
...
const BlogSchema = new mongoose.Schema({
    ...
    tag:[{type:objectId,required:false,ref:'caseStudyTag'}],
    publish:{type:String,required:false},
    type:{type:String,required:false,enum:['STUDY','INDUSTRY']},
...
module.exports = mongoose.model('caseStudy', BlogSchema);